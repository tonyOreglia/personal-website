...
export const postInfo = data.find((post) => post.id === 5);
export const babelRoulettePost = `
## The Difficulty with Learning a New Language
In the past year and a half learned Portuguese, I've learned some things about how to pick up a second language. In my opinion, the most useful method by far when it comes to learning a new language is (maybe not surprisingly) chatting with native speakers. The more often the better.

...
__[Check out a live demo of my spatial server here!](/breadcrumbs)__

## What is the potential for Location Based Social Networks 
The potential for this type of networking are vast and already there are a number of applications on the market experimenting with this concept. Notably, 
[Pokémon GO](https://pokemongolive.com/en/) enables users to find Pokémon out in the real world via augmented reality seen through the phone. Others, like [Wallame](https://en.wikipedia.org/wiki/WallaMe), provide a platform to create virtual graffiti. [Holo](https://holo.me/) is already experimenting with location based holograms. 
